...
class OffsetsConfig:
    ...
    def from_config(cls, config):
        ...
        client_offsets = {
            ...
            "localPlayerController": config.get_offset(
                "client_dll", "localPlayerController"
            ),
        ...
        pawn_data = {
            k: config.get_offset("pawn", k) for k in PawnOffsets.__dataclass_fields__
        }

        bomb_data = {
            k: config.get_offset("bomb", k) for k in BombOffsets.__dataclass_fields__
        }

        bone_data = {"m_modelState": config.get_offset("bone", "m_modelState")}
